...
export class Home{
  ...
  sccontent1 = `
				...
				Oke sekarang saat nya kita download angular mvc dengan cara buka terminal kamu dan kini jalankan "git clone https://github.com/Rafael-Lee1/angular-mvc.git "
				`;
